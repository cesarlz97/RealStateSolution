...
{
    public partial class ClientSelectorUserControl : UserControl
    {
        ...
        private List<Client> _items;

        public ClientSelectorUserControl()
        {
            InitializeComponent();
        }
        ...
        private void UpdateItemsCount()
        {
            ...
            if (!string.IsNullOrWhiteSpace(textBoxSearch.Text))
                ...
                {
                    { nameof(Client.Surname), $"%{textBoxSearch.Text.Trim()}%" }
                };

            _count = _sqliteManager.CountRecords<Client>(whereClauses: whereClauses);
        }
        ...
        private void LoadItems()
        {
            ...
            _items = _sqliteManager.ReadData<Client>(limit: _limit, offset: _offset, whereClauses);
        ...
        public void FillContent()
        {
            ...
            foreach (var item in _items)
            {
                ...
                this.exListBoxUserControl.Items.Add(new ExListBoxItem(item.Id, fullName, details, item.GetProfileImage()));
            }
